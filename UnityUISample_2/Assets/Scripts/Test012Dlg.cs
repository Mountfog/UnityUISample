...
public class Test012Dlg : MonoBehaviour
{
    ...
    List<CItemText> m_listItem = new List<CItemText>();
    public List<string> listAnimal = new List<string>() { "사자", "고양이", "호랑이", "독수리" };
    int selectedValue = 0;
    CItemText curItem = null;
    ...
    void SpawnItem(string name, int idx)
    {
        ...
        CItemText kText = go.GetComponent<CItemText>();
    ...
    public void OnClick_Clear()
    {
        ...
        /*
        CItemText kitem = m_listItem[selectedValue];
        m_listItem.Remove(kitem);
        listAnimal.RemoveAt(selectedValue);
